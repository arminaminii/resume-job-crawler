...
urlpatterns = [
    ...
    path('api/tehran-districts/', views.tehran_districts_api, name='tehran_districts_api'),
    path('api/tehran-neighborhoods/', views.tehran_neighborhoods_api, name='tehran_neighborhoods_api'),
