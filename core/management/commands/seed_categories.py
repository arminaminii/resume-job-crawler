...
CATEGORIES = [
    ...
    {'name': 'تست و کنترل کیفیت نرم‌افزار', 'slug': 'qa-testing', 'icon': 'developer', 'color': '#0891b2', 'jv': 'developer', 'es': 'تست-نرم-افزار', 'sort': 10,
    ...
    {'name': 'توسعه بازی و گیم', 'slug': 'game-dev', 'icon': 'game', 'color': '#7c3aed', 'jv': 'developer', 'sort': 11,
    ...
    {'name': 'پایگاه داده و DBA', 'slug': 'database', 'icon': 'data', 'color': '#0d9488', 'jv': 'developer', 'sort': 12,
    ...
    # ===== طراحی و خلاقیت =====
    {'name': 'طراحی گرافیک و UI/UX', 'slug': 'ui-ux', 'icon': 'design', 'color': '#ec4899', 'jv': 'ui-ux', 'es': 'طراحی', 'sort': 13,
    ...
    {'name': 'طراحی وب و قالب', 'slug': 'web-design', 'icon': 'frontend', 'color': '#a855f7', 'jv': 'developer', 'es': 'طراحی-وب', 'sort': 14,
    ...
    {'name': 'انیمیشن و موشن‌گرافیک', 'slug': 'animation', 'icon': 'design', 'color': '#d946ef', 'jv': 'design', 'es': 'انیمیشن', 'sort': 15,
    ...
    {'name': 'عکاسی و تدوین ویدیو', 'slug': 'photography', 'icon': 'design', 'color': '#f472b6', 'jv': 'design', 'es': 'عکاسی', 'sort': 16,
    ...
    # ===== بازاریابی و فروش =====
    {'name': 'بازاریابی دیجیتال و سئو', 'slug': 'digital-marketing', 'icon': 'marketing', 'color': '#14b8a6', 'jv': 'digital-marketing', 'es': 'بازاریابی', 'sort': 17,
    ...
    {'name': 'فروش و توسعه کسب‌وکار', 'slug': 'sales', 'icon': 'sales', 'color': '#f97316', 'jv': 'business-development', 'es': 'فروش', 'sort': 18,
    ...
    {'name': 'روابط عمومی و برندینگ', 'slug': 'pr-branding', 'icon': 'marketing', 'color': '#fb923c', 'jv': 'digital-marketing', 'es': 'روابط-عمومی', 'sort': 19,
    ...
    {'name': 'تولید محتوا و کپی‌رایتینگ', 'slug': 'content', 'icon': 'content', 'color': '#d946ef', 'jv': 'content', 'es': 'محتوا', 'sort': 20,
